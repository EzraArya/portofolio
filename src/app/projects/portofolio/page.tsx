        ...
        <main>
            ...
            <div className="flex flex-col-reverse gap-20 md:flex-row w-screen/2 m-14 items-center h-4/5 justify-evenly" id="hero">
                <div className="flex flex-col gap-2 justify-center font-montserrat">
                    <h1 className="font-semibold text-4xl">Portofolio Website</h1>
                    <h1 className="font-light text-lg">This is a portofolio website to show all my project and to know more about myself, this is my first attempt at NextJs hoping to improve it much more</h1>
                    <h1 className="font-semibold text-2xl">Techstack Used:</h1>
                    <div className="flex overflow-x-auto gap-4 mt-4">
                        <img className="w-10 h-10" src="/next.svg" alt="NextJs Logo"></img>
                ...
                <img className="relative z-10 drop-shadow-xl round-md w-[30rem] h-[20rem] md:w-[40rem] md:h-[26rem] object-contain right-14" src="/image/portofolio/home.png" alt="Your Image" />
            </div>        
