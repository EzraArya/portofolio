        ...
        <main>
            <nav className='flex justify-between m-14'>
                <div>
                    <ul className="gap-6 flex justify-start font-montserrat font-bold text-2xl drop-shadow-md">
                        <li>
                            <Link href="/" className='hover:animate-bounce hover:underline decoration-blue-500 decoration-3 decoration-wavy'>
                                <h1>
                                    Home
                                </h1>
                            </Link>
            ...
            <div className="flex flex-col-reverse gap-20 md:flex-row w-screen/2 m-14 items-center h-4/5 justify-evenly" id="hero">
                <div className="flex flex-col gap-2 justify-center font-montserrat">
                    <h1 className="font-semibold text-4xl">LapangPedia</h1>
                    <h1 className="font-light text-lg">his is a project that i worked with my team, where I'am responsible as a full-stack developer in this project. This website is an auction website where user can bid and auction their product. The techstack that is used in this project are Laravel framework with MySQL as it database, Tailwind, Flowbite, and Bootstrap</h1>
                    <h1 className="font-semibold text-2xl">Techstack Used:</h1>
                    <div className="flex overflow-x-auto gap-4 mt-4">
                        <img className="w-8 h-8" src="/laravel.svg" alt="" />
                        <img className="w-12 h-12"src="/MySQL.svg" alt="" />
                ...
                <img className="relative z-10 border border-black/50 drop-shadow-xl round-md w-[30rem] h-[20rem] md:w-[40rem] md:h-[26rem] object-contain right-14" src="/image/lapangpedia/home.png" alt="Your Image" />
            </div>        
            <div className="flex m-14 flex-col">
                ...
                <div className="flex flex-wrap justify-center items-center w-full gap-6">
                    <img className="relative z-10  drop-shadow-xl w-[30rem] h-[20rem] md:w-[32rem] md:h-[26rem] object-contain right-14" src="/image/lapangpedia/login.png" alt="Your Image" />
                    <img className="relative z-10  drop-shadow-xl w-[30rem] h-[20rem] md:w-[32rem] md:h-[26rem] object-contain right-14" src="/image/lapangpedia/list-product.png" alt="Your Image" />
                    <img className="relative z-10  drop-shadow-xl w-[30rem] h-[20rem] md:w-[32rem] md:h-[26rem] object-contain right-14" src="/image/lapangpedia/product.png" alt="Your Image" />
                    <img className="relative z-10  drop-shadow-xl w-[30rem] h-[20rem] md:w-[32rem] md:h-[26rem] object-contain right-14" src="/image/lapangpedia/home.png" alt="Your Image" />
