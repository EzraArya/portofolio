...
export function FloatingNav() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1 px-2 py-2 rounded-full border border-white/[0.08] bg-black/40 dark:bg-transparent backdrop-blur-xl backdrop-saturate-[1.8] shadow-lg shadow-black/20 dark:shadow-black/40">
        {/* Subtle inner glow */}
        ...
        <button
          ...
          className="relative flex items-center justify-center w-8 h-8 rounded-full text-white/50 hover:text-white/80 hover:bg-white/[0.08] transition-all duration-200"
