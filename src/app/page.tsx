     ...
     <div className="flex flex-col-reverse gap-20 md:flex-row w-screen/2 m-14 items-center h-4/5 justify-evenly" id="hero">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="relative items-center">
            ...
            <Image className="relative z-10 border border-black/50 drop-shadow-xl rounded-full w-[20rem] h-[20rem] md:w-[26rem] md:h-[26rem] object-cover right-14" width={550} height={550} src="/image/Skeb Media Post copy.jpeg" alt="Your Image" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 m-14 items-center h-screen justify-center" id="about">
        <div className="flex flex-col justify-center items-center">
          <div className="relative">
            ...
            <Image className="relative z-10 border border-black/50 drop-shadow-xl rounded-3xl w-[24rem] h-[28rem] object-cover right-14" width={550} height={550} src="/image/Skeb Media Post copy.jpeg" alt="Your Image" />
          </div>
        </div>
        <div className="flex justify-center">
      ...
      <div className="grid mr-20 ml-36 p-8  items-center  h-screen justify-start " id="project">
        <div className="flex justify-center">
          <div className="flex flex-col items-start gap-2 mt-6">
            ...
            <p className="font-montserrat font-light text-xl">Here's a list of project that i developed throughout my carrer</p>
            <div className="gap-4 flex flex-col">
              <a href="#" className="flex flex-col items-center  bg-white border border-gray-200 rounded-xl shadow md:flex-row md:max-w-6xl hover:bg-gray-100 md:max-h-96">
                  ...
                  <div className="flex flex-col justify-between p-4 leading-normal">
                      ...
                      <div className="flex w-full justify-center">
                        <div className="flex flex-row gap-2 border rounded-xl w-40 h-9 justify-center items-center hover:bg-gray-200 drop-shadow-md">
