        ...
        <motion.div variants={stagger} className="space-y-3">
          {contactLinks.map((link) => (
            <motion.a
              ...
              className="flex items-center gap-4 rounded-xl border border-border bg-card/50 backdrop-blur-sm p-4 transition-all duration-300 hover:bg-accent/50 hover:border-blue-400/30 hover:-translate-y-0.5 group"
            >
              ...
              <span className="text-muted-foreground group-hover:text-foreground transition-all duration-200 group-hover:translate-x-0.5">
